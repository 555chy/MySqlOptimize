...
CREATE INDEX idx_users_status ON users(is_active, account_type);
CREATE INDEX idx_users_loyalty ON users(loyalty_tier, loyalty_points);

CREATE INDEX idx_categories_parent ON categories(parent_category_id);
CREATE INDEX idx_categories_slug ON categories(category_slug);
CREATE INDEX idx_categories_visible ON categories(is_visible, display_order);

CREATE INDEX idx_brands_slug ON brands(brand_slug);
CREATE INDEX idx_brands_status ON brands(is_visible, is_featured);
...
CREATE INDEX idx_products_status ON products(is_active, is_visible, is_featured);
CREATE INDEX idx_products_stock ON products(stock_status, stock_quantity);
CREATE INDEX idx_products_price ON products(price, is_on_sale);
CREATE INDEX idx_products_rating ON products(average_rating DESC, review_count DESC);

CREATE INDEX idx_inventory_product ON inventory(product_id);
CREATE INDEX idx_inventory_warehouse ON inventory(warehouse_id, warehouse_location);
CREATE INDEX idx_inventory_quantity ON inventory(quantity, available_quantity);

CREATE INDEX idx_orders_user ON orders(user_id);
CREATE INDEX idx_orders_date ON orders(order_date);
CREATE INDEX idx_orders_status ON orders(order_status, fulfillment_status, payment_status);
CREATE INDEX idx_orders_number ON orders(order_number);
CREATE INDEX idx_orders_customer ON orders(customer_email, customer_phone);

CREATE INDEX idx_order_items_order ON order_items(order_id);
CREATE INDEX idx_order_items_product ON order_items(product_id);
CREATE INDEX idx_order_items_fulfillment ON order_items(fulfillment_status, is_backorder);

CREATE INDEX idx_payments_order ON payments(order_id);
CREATE INDEX idx_payments_transaction ON payments(transaction_id);
CREATE INDEX idx_payments_status ON payments(status, payment_method);
...
CREATE INDEX idx_shipping_status ON shipping(status, carrier);
CREATE INDEX idx_shipping_date ON shipping(shipping_date, actual_delivery_date);

CREATE INDEX idx_reviews_product ON reviews(product_id);
CREATE INDEX idx_reviews_user ON reviews(user_id);
CREATE INDEX idx_reviews_rating ON reviews(rating DESC, review_date DESC);
CREATE INDEX idx_reviews_status ON reviews(is_approved, is_featured, is_verified_purchase);
